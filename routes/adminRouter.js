...
router.get("/export-excel", adminAuth, adminController.generateExcelReport); // Add this line
...
// router.get("/orderDetails",adminAuth,orderController.orderDetailsAdmin)
